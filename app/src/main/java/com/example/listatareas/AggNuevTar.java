...
public class AggNuevTar extends BottomSheetDialogFragment {

    public static final String TAG = "AggNuevTar";
    ...
    public static AggNuevTar newInstance(){
        return new AggNuevTar();
    }
        ...
        mSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               if (finalIsUpdate){
                   ...
                   LisTarModel item = new LisTarModel();
                   item.setTask(text);
                   item.setStatus(0);
